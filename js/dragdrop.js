...
*   Stefano Ricci  01/Oct/2008
*   +JsAdmin.buttonCell
*   +JsAdmin.structure_type == 'ul' || 'table'
*   +JsAdmin.buttonCell
*   +Restore backgroundColor from previous one (if false ? white)
*	
*   Swen Uth; 01/24/2008
...
JsAdmin.init_drag_drop = function() {
	...
	} else if (JsAdmin.structure_type == 'table') {
		page_type = 'sections';
	} else {
...
JsAdmin.DD.trDDSwap = function(id, sGroup) {
    ...
    this.initFrame();
	this.buttonCell = JsAdmin.buttonCell;//, by Swen Uth
...
JsAdmin.DD.trDDSwap.prototype.endDrag = function(e) {
	...
	var OldBackground =this.getEl().style.backgroundColor;
	
	YAHOO.util.Dom.setStyle(this.getEl(), "background", OldBackground ? OldBackground : "white");
